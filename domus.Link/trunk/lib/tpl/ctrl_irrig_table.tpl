 ...
 <td align="center" width="50%">
  ...
  <table cellspacing="0" cellpadding="0" border="0">
   <tr>
    ...
    <td><? if (on_state($code, $config['heyuexec'])): ?><img src="<?=$config['url_path'];?>/theme/<?=$config['theme'];?>/images/ctrlbox_irrig_on.gif" /><? else: ?><img src="<?=$config['url_path'];?>/theme/<?=$config['theme'];?>/images/ctrlbox_irrig_off.gif" /><? endif; ?></td>
