  ...
  <?php  foreach($aliases as $line_num => $alias): ?>
    <?php  if (substr($alias, 0, 5) == "ALIAS"): ?>
      ...
      <tr>
        ...
        <td><?php echo $type;?></td>
        <td class="cell_center"><a href="<?php $_SERVER['PHP_SELF'];?>?action=edit&line=<?php echo $line_num;?>"><?php echo ($lang['edit']);?></a></td>
        <td class="cell_center"><a href="<?php $_SERVER['PHP_SELF'];?>?action=del&line=<?php echo $line_num;?>" onclick="return confirm('<?php echo ($lang['deleteconfirm']);?>')"><?php echo ($lang['delete']);?></a></td>
      </tr>
	<?php endif; ?>
  <?php  endforeach; ?>
</table>
