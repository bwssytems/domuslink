...
$lang["heyuconfile_txt"]="Het configuratie bestand bevat enkele kritische stukken informatie die het Heyu programma nodig heeft om te functioneren, aangevuld met een aantal gebruikersopties. Dit bestand is normaal gesproken <span class='code'>x10.conf</span> genaamden is terug te vinden in <span class='code'>/etc/heyu</span> om systeem breed te worden gebruikt.";
$lang["urlpath_txt"]="Deze optie bepaalt welke directory moet worden gebruikt voor de gebruikersinterface. Als je domus.Link draait in een onderliggende directory, bijvoorbeeld <span class='code'>http://your-host/domuslink</span>, kies dan hier voor <span class='code'>/domuslink</span>. Laat deze optie leeg indien je domus.Link in de root-directory (bijvoorbeeld <span class='code'>http://your-host/</span>)";
