...
<tr>
  <td></td>
  <td></td>
  <td colspan="2" align="center" style="border-bottom: 1px dotted #e5e5e5;"><h6>Date Range</h6></td>
  <td></td>
  <td colspan="2" align="center" style="border-bottom: 1px dotted #e5e5e5;"><h6>Time</h6></td>
  <td></td>
</tr>
<tr>
  <td><h6>Module</h6></td>
  <td width="100" align="center"><h6><?php echo ($lang['weekdays']);?></h6></td>
  <td width="100" align="center"><h6><?php echo ucwords($lang['start']);?></h6></td>
  <td width="100" align="center"><h6><?php echo ($lang['end']);?></h6></td>
  <td width="20"></td>
...
line num: <?php echo $line_num; ?> - wkdays: <?php echo $weekdays; ?> - dateonoff: <?php echo $dateonoff; ?>
 ...
 <tr <?php if (!$enabled) echo "style='color: #cccccc'"; ?> ">
  <td></td>
  <td align="center"><?php echo parse_weekdays($weekdays); ?></td>
