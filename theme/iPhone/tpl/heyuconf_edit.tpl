...
<?php foreach($settings as $setting):
  ...
  <?php else: // if not alias, scene or usersyn ?>
    ...
    <?php if ($directivenf == "SCRIPT_MODE"): ?> <td width="60%" valign='top'>
      ...
      <?php elseif ($directivenf == "MODE"): ?> <td width="60%" valign='top'>
        <select name="<?php echo($directivenf); ?>">
      ...
      $directivenf == "WRITE_CHECK_FILES" || $directivenf == "ACK_HAILS" || $directivenf == "AUTOFETCH"): ?> <td width="60%" valign='top'>
        <select name="<?php echo($directivenf); ?>">
          <?php echo yesnoopt($value); ?>
        </select>
      </td>
      <?php elseif ($directivenf == "DAWN_OPTION" || $directivenf == "DUSK_OPTION"): ?> <td width="60%" valign='top'>
        <select name="<?php echo($directivenf); ?>">
          <?php echo dawnduskopt($value); ?>
        </select>
      </td>
      <?php else: ?> <td width="60%" valign='top'>
