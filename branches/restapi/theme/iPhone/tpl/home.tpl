<ul id="home" title="domus.Link" selected="true">
	...
	<?php foreach($groups as $group) : ?>
		...
		<?php endif; ?>
	<?php endforeach; ?>
	<li><a id='menu_status' href="<?php echo ($config['url_path']); ?>/index.php?page=domus_status_page"><img src="<?php echo ($config['url_path']);?>/theme/iPhone/images/menu_status_on.gif">&nbsp;&nbsp;<?php echo ($lang['heyustatus']);?></a></li>
