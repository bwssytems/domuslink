...
define("USERDB_FILE_LOCATION", dirname(__FILE__) . DIRECTORY_SEPARATOR . 'db' . DIRECTORY_SEPARATOR . 'userdb');
define("MODULE_FILE_LOCATION", dirname(__FILE__) . DIRECTORY_SEPARATOR . 'db' . DIRECTORY_SEPARATOR . 'moduletypes');
define("GROUP_FILE_LOCATION", dirname(__FILE__) . DIRECTORY_SEPARATOR . 'db' . DIRECTORY_SEPARATOR . 'groups');
...
define("UTILITY_FILE_LOCATION", dirname(__FILE__) . DIRECTORY_SEPARATOR . 'utility' . DIRECTORY_SEPARATOR);
