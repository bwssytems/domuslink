...
class heyuSched extends ElementFile {

	protected function createElement($aLine) {
		return ScheduleElementFactory::createElement($aLine);
	}
	...
	function getMacroObjects() {
		return $this->getElementObjects(MACRO_D);
	}
	...
	function getTimerObjects() {
		return $this->getElementObjects(TIMER_D);
	}
	...
	function getTriggerObjects() {
		return $this->getElementObjects(TRIGGER_D);
	}
	...
	function getConfigObjects() {
		return $this->getElementObjects(CONFIG_D);
	}
}
?>