...
public class DevicesItemClickListener implements OnItemClickListener, DomusAsyncUpdater {
	...
	public void actionComplete(String[] result) {
		...
		if(theSelectedDevice.getAliasMapElement().getElementType().compareTo("Light") == 0)
		{
		...
		else if(theSelectedDevice.getAliasMapElement().getElementType().compareTo("Appliance") == 0)
		{
