        ...
        foreach($aliases as $alias_num):
			...
			<table>
				<tr>
					...
					<td><a href="<?php echo ($_SERVER['PHP_SELF']); ?>?action=edit&line=<?php echo $line_num;?>#edit"><img width=20 height=20 src="<?php echo ($config['url_path']);?>/theme/iPhone/images/icontexto-webdev-config-024x024.png" /></a></td>
