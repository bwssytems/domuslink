...
-->
  <div id="menuitem_img"><a href="<?php echo ($config['url_path']);?>/index.php?page=main"><img alt="<?php echo ($lang['all']);?>" src="<?php echo ($config['url_path']);?>/theme/<?php echo ($config['theme']);?>/images/menu_all_off.gif" border="0" name="img_1" /></a></div>
  <div id="menuitem_img"><a href="<?php echo ($config['url_path']);?>/index.php?page=lights"><img alt="<?php echo ($lang['lights']);?>" src="<?php echo ($config['url_path']);?>/theme/<?php echo ($config['theme']);?>/images/menu_lights_off.gif" border="0" name="img_2" /></a></div>
  <div id="menuitem_img"><a href="<?php echo ($config['url_path']);?>/index.php?page=appliances"><img alt="<?php echo ($lang['appliances']);?>" src="<?php echo ($config['url_path']);?>/theme/<?php echo ($config['theme']);?>/images/menu_appliances_off.gif" border="0" name="img_3" /></a></div>
  <div id="menuitem_img"><a href="<?php echo ($config['url_path']);?>/index.php?page=irrigation"><img alt="<?php echo ($lang['irrigation']);?>" src="<?php echo ($config['url_path']);?>/theme/<?php echo ($config['theme']);?>/images/menu_irrigation_off.gif" border="0" name="img_4" /></a></div>
...
<!--  <div id="menuitem_img"><a href="<?php echo ($config['url_path']);?>/index.php"><img alt="<?php echo ($lang['events']);?>" src="<?php echo ($config['url_path']);?>/theme/<?php echo ($config['theme']);?>/images/menu_events_off.gif" border="0" name="img_6" /></a></div> -->
  <div id="menuitem_img"><a href="<?php echo ($config['url_path']);?>/admin/setup.php"><img alt="<?php echo ($lang['setup']);?>" src="<?php echo ($config['url_path']);?>/theme/<?php echo ($config['theme']);?>/images/menu_setup_off.gif" border="0" name="img_7" /></a></div>
<?php endif; ?>
</div>
<!-- end menu div -->
